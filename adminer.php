...
is_email($sf){$ge='[-a-z0-9!#$%&\'*+/=?^_`{|}~]';$mc='[a-z0-9]([-a-z0-9]{0,61}[a-z0-9])';$ia="$ge+(\\.$ge+)*@($mc?\\.)+$mc";return
...
page_header($Je,$n="",$sc=array(),$Ke=""){global$Wa,$ec,$r,$g,$ja;header("Content-Type: text/html; charset=utf-8");header("X-Frame-Options: deny");$Td=$Je.($Ke!=""?": ".h($Ke):"");$nc=($ec?"https":"http");echo'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN">
<html lang="',$Wa,'">
...
';}echo'
<body onload="bodyLoad(\'',(is_object($g)?substr($g->server_info,0,3):""),'\', \'',$nc,'\');',(isset($_COOKIE["adminer_version"])?"":" verifyVersion('$nc');"),'">
